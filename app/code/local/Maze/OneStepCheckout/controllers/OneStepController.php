<?php
/**
 * Maze_OneStepCheckout controller class
 *
 * PHP version 5.4
 *
 * @category  Maze
...
/** Maze_OneStepCheckout_OnestepController
 *
 * @category Maze
 * @package  Maze_OneStepCheckout
 *
...
class Maze_OneStepCheckout_OnestepController extends Mage_Checkout_OnepageController
{
    /**
    ...
    {
        return Mage::getSingleton('maze_onestep/type_onestep');
    }
    ...
    {
        if (!Mage::helper('maze_onestep')->oneStepCheckoutEnabled()) {
